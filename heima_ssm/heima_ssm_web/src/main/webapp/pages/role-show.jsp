                        ...
                        <div class="tab-pane" id="tab-treetable">
                            <table id="collapse-table"
                                ...
                                <c:if test="${!empty role.users}">
                                    <tr>
                                        <td colspan="2">角色对应用户</td>
                                    </tr>
                                </c:if>

                                <c:forEach items="${role.users}" var="user" varStatus="vs">

                                    <tr data-tt-id="${vs.index+1000}">

                                        <td colspan="2">${user.username}</td>
                                    </tr>

                                    <tr data-tt-id="0" data-tt-parent-id="${vs.index+1000}">
                                        <td>${user.username }</td>
                                        <td>${user.email }</td>
                                    </tr>
